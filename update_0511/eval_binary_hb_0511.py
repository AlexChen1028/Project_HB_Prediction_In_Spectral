"""
Evaluate trained binary classifier: d2_hb_binary_model_0511.pth
...
# ==========================================
# Parameters (must match train_binary_hb_0511.py)
# ==========================================
...
def evaluate():
    ...
    if not os.path.exists(MODEL_PATH):
        print(f"Model not found: {MODEL_PATH}\nRun train_binary_hb_0511.py first."); return
    ...
    if len(np.unique(y_te)) > 1:
        draw_4panel(y_te, probs, preds, os.path.join(OUT_DIR, 'eval_binary_hb_0511.png'))
