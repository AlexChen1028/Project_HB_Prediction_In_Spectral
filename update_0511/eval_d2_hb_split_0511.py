"""
Evaluate trained d2 regression models: d2_hb_low_model_0511.pth / d2_hb_high_model_0511.pth
...
# ==========================================
# Parameters (must match train_d2_hb_split_0511.py)
# ==========================================
BASE_DIR        = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
MUA_FOLDER      = os.path.join(BASE_DIR, 'mua')
OUT_DIR         = os.path.dirname(os.path.abspath(__file__))
LOW_MODEL_PATH  = os.path.join(OUT_DIR, 'd2_hb_low_model_0511.pth')
HIGH_MODEL_PATH = os.path.join(OUT_DIR, 'd2_hb_high_model_0511.pth')
...
def evaluate():
    ...
    out_dir = os.path.dirname(os.path.abspath(__file__))
    draw_4panel(y_true, y_pred, colors, os.path.join(out_dir, 'eval_d2_hb_split_0511.png'))
